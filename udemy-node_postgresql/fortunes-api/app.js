...
app.get('/fortunes', (req, res) => res.json(fortunes))
app.get('/fortunes/:id', (req, res) => res.json(fortunes.find(f => f.id == req.params.id)))
app.get('/fortunes/random', (req, res) => res.json(fortunes[Math.floor(Math.random() * fortunes.length)]))
...
// app.delete('/fortunes/:id', (req, res) => writeFortunes(fortunes.filter(f => f.id != req.params.id)))
